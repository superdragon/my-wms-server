...
@RocketMQMessageListener(
        consumerGroup = "paySuccessNotifyGroup",
        topic = "paySuccess",
        messageModel = MessageModel.CLUSTERING,
        consumeMode = ConsumeMode.CONCURRENTLY
)
public class PaySuccessNotifyConsumer implements RocketMQListener<MessageExt> {
    ...
    public void onMessage(MessageExt messageExt) {
        ...
        if (StrUtil.isNotEmpty(msg)) {
            ...
            // 统计
            todayStatService.pushNotifyPaySuccessInfo(detail);
        } else {
